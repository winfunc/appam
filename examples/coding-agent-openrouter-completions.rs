//! TUI Coding Agent using OpenRouter Completions API with GPT-4o
//!
//! A minimal terminal interface coding assistant with:
//! - Multi-turn conversation loop
//! - File operations (read, write, list)
//! - Bash command execution
//! - Provider routing (Anthropic preferred)
...
async fn main() -> Result<()> {
    println!("🚀 Coding Agent - GPT-4o via OpenRouter Completions API\n");

    // Configure provider routing preferences
    ...
    // Build agent with OpenRouter Completions configuration
    let agent = AgentBuilder::new("gpt-coding-assistant")
        ...
        // Note: OpenRouter Completions API reasoning support depends on the model
        // Claude 3.5 Sonnet doesn't support extended thinking; disable for stability
        // .reasoning(...)
        // Provider routing with privacy controls
    ...
    println!("✓ Provider: Anthropic (preferred), ZDR enabled");
    println!("✓ Data collection: Denied for privacy");
