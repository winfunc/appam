...
The exact `gpt-5.6-sol` model accepts an explicit `XHigh` request through the
direct OpenAI and Azure OpenAI transports. Its model-aware default remains
`High`, and unknown suffixed variants remain fail-closed.
